...
**This project is a fork of [cloudposse/build-harness](github.com/cloudposse/build-harness). Like the parent project, this is licensed under the [APACHE2](LICENSE).**
