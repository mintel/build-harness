...
# Build Harness [![Build Status](https://travis-ci.org/mintel/build-harness.svg?branch=master)](https://travis-ci.org/mintel/build-harness) [![Latest Release](https://img.shields.io/github/release/mintel/build-harness.svg)](https://github.com/mintel/build-harness/releases/latest)
...
![demo](https://cdn.rawgit.com/mintel/build-harness/master/docs/demo.svg)
...
jobs:
  build:
    ...
    - uses: mintel/build-harness@master
      with:
...
1. `git clone https://github.com/mintel/build-harness.git` to pull down the repository
2. `make init` to initialize the [`build-harness`](https://github.com/mintel/build-harness/)
...
Copyright © 2019-2019 [Mintel](https://mintel.com)
